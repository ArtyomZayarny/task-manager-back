...
let TaskController = exports.TaskController = class TaskController {
    ...
    async createTasktask(task) {
        return this.taskService.create(task);
    }
    async fetchTaskListByUserId(id) {
        return this.taskService.getTasksByUserId(id);
    }
    async deleteTask(id) {
        const deletedProduct = this.taskService.deleteTask(id);
        if (!deletedProduct) {
            throw new common_1.NotFoundException(constants_1.TASK_NOT_FOUND);
        }
    }
...
], TaskController.prototype, "createTasktask", null);
__decorate([
    (0, common_1.UseGuards)(jwt_guard_1.JwtAuthGuard),
    (0, common_1.Get)(':id'),
    ...
    __metadata("design:returntype", Promise)
], TaskController.prototype, "fetchTaskListByUserId", null);
__decorate([
    (0, common_1.UseGuards)(jwt_guard_1.JwtAuthGuard),
